package za.ac.cput.assignment.dip.obey.conf;

import java.math.BigDecimal;
import org.springframework.beans.factory.annotation.Configurable;
import org.springframework.context.annotation.Bean;
import za.ac.cput.assignment.dip.obey.model.Employee;
import za.ac.cput.assignment.dip.obey.model.Name;
import za.ac.cput.assignment.dip.obey.service.internal.MockEmployeeReporter;
import za.ac.cput.assignment.dip.obey.service.internal.MockEmployeeRepository;
...
{
    @Bean
    public MockEmployeeRepository provideEmployeeRepository()
    {
    ...
    {
        return new MockEmployeeReporter(provideEmployeeRepository());
    }
}
